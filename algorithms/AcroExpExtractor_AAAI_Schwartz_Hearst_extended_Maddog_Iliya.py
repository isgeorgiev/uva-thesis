...
class AcroExpExtractor_AAAI_Schwartz_Hearst_extended_Maddog_Iliya(AcroExpExtractorRb):
    ...
    def get_acronyms_expansions_from_text(self, text):
        ...
        return acronyms_maddog

if __name__ == "__main__":
    acroExp = AcroExpExtractor_AAAI_Schwartz_Hearst_extended_Maddog_Iliya()
